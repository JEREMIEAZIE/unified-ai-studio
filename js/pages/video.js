...
export default {
            ...
            <div class="page-workspace">
                <div class="workspace-layout">
                    <div class="workspace-main">
                        <div class="mode-tabs">
                            <button class="mode-tab active">Video Studio</button>
                        </div>
                    ...
                    <div class="settings-panel">
                        ...
                        <div class="setting-group">
                            ...
                            <select class="setting-select" id="vid-dur">
                                <option value="49">2s</option>
                                <option value="73">3s</option>
                                <option value="121" selected>5s</option>
                                <option value="193">8s</option>
                            </select>
                        </div>
                        <div class="setting-group">
                            <label class="setting-label">Resolution</label>
                            <select class="setting-select" id="vid-res">
                        ...
                        <div class="setting-group">
                            ...
                            <select class="setting-select" id="vid-ar">
                        ...
                        <div class="setting-row">
                            <div class="setting-group">
                                ...
                                <input type="number" class="setting-input" id="vid-steps" value="8" min="2" max="50">
                            </div>
                            <div class="setting-group">
                                <label class="setting-label">Guide Scale</label>
                                <input type="number" class="setting-input" id="vid-guide" value="3.0" step="0.5" min="1" max="8">
                            </div>
                        </div>
                        <div class="setting-group">
                            <label class="setting-label">Seed (-1 = random)</label>
                            <input type="number" class="setting-input" id="vid-seed" value="-1">
                        </div>
    ...
    onLoad() {
        ...
        if (input) {
            input.placeholder = 'Describe the video scene...';
        }
    },

    onUnload() {
        console.log('Video Studio unloaded');
    }
};
    ...
    if (stage) {
        stage.innerHTML = `
            <div class="loading-overlay">
                ...
                <div class="loading-text">Rendering video...</div>
            </div>`;
    }
