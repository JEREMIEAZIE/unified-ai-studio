export default {
            ...
            <div class="page-workspace">
                <div class="workspace-layout">
                    <div class="workspace-main">
                        <div class="mode-tabs"><button class="mode-tab active">Image Studio</button></div>
                    ...
                    <div class="settings-panel">
                        ...
                        <div class="setting-group">
                            ...
                            <select class="setting-select" id="img-res"><option value="1024">1024px</option><option value="768">768px (Faster)</option></select>
                        </div>
                        <div class="setting-group">
                            <label class="setting-label">Aspect Ratio</label>
                            <select class="setting-select" id="img-ar"><option value="1:1">1:1 Square</option><option value="16:9">16:9 Landscape</option><option value="9:16">9:16 Portrait</option><option value="4:3">4:3 Standard</option></select>
                        </div>
                        <div class="setting-row">
                            <div class="setting-group"><label class="setting-label">Steps</label><input type="number" class="setting-input" id="img-steps" value="4" min="1" max="50"></div>
                            <div class="setting-group"><label class="setting-label">Images</label><input type="number" class="setting-input" id="img-num" value="1" min="1" max="4"></div>
                        </div>
                        <div class="setting-group"><label class="setting-label">Seed (-1 = random)</label><input type="number" class="setting-input" id="img-seed" value="-1"></div>
                        <div class="setting-group"><label class="setting-label">Negative Prompt</label><input type="text" class="setting-input" id="img-neg" placeholder="ugly, blurry, distorted"></div>
    ...
    onUnload() { console.log('Image Studio unloaded'); }
};
...
window.handleImageGenerate = async function(prompt) {
    ...
    if (stage) {
        stage.innerHTML = `<div class="loading-overlay"><div class="spinner"></div><div class="progress-bar"><div class="progress-fill" id="progress-fill"></div></div><div class="loading-text">Generating image...</div></div>`;
    }
    ...
    try {
        ...
        if (stage) {
            if (data.result_urls && data.result_urls.length > 0) {
                stage.innerHTML = `<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(150px, 1fr)); gap:12px; padding:16px; width:100%;">${data.result_urls.map(url => {
